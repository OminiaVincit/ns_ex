...
#Trace setup
#set fall [open kadai1b.tr w]
#$ns trace-all $fall

#set fnam [open kadai1b.nam w]
#$ns namtrace-all $fnam

#set ftcp [open kadai1b.tcp w]

# Open the window plot file
set tcp_flow0_file [open tcp_flow0_file_delay.dat w]
set tcp_flow1_file [open tcp_flow1_file_delay.dat w]
...
$ns duplex-link $s1 $n0 10Mb 100ms DropTail
